...
>
> `uses: noru-tech/noru-review-action@v0.9.0` and
> `uses: noru-tech/noru-grc-engineering/.github/actions/noru-review@v0.9.0`
...
The [supported template](https://github.com/noru-tech/noru-grc-engineering/blob/v0.9.0/templates/github/noru-grc-review.yml) is the recommended start.
...
the [changelog](https://github.com/noru-tech/noru-grc-engineering/blob/v0.9.0/CHANGELOG.md).

## Support and contributing

The end-to-end rollout, from installing the pieces to the separate publication step, is in
[developer onboarding](https://github.com/noru-tech/noru-grc-engineering/blob/v0.9.0/docs/developer-onboarding.md). The action is built and tested in
...
[security policy](https://github.com/noru-tech/noru-grc-engineering/blob/v0.9.0/SECURITY.md). Open issues and pull requests there, not in the
